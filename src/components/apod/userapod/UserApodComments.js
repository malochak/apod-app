...
export default class UserApodComments extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        ...
        firebase.app.database().ref(`userApods/${this.props.apodId}/comments`).on('value', (snapshot) => {
            this.setState({
    ...
    addComment() {
        ...
        if (comment.trim().length > 0) {
            ...
            var commentsDb = firebase.app.database().ref(`userApods/${this.props.apodId}/comments`);
